    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.TextField(blank=True, default='https://res.cloudinary.com/ebanisteria/image/upload/v1655927656/profile_dajoka.png', null=True, verbose_name='Imagen de perfil')),
                ('rolUser', models.CharField(default='Cliente', max_length=30, verbose_name='Rol de usuarios')),
                ('direccion', models.TextField(blank=True, null=True)),
                ('edad', models.IntegerField(blank=True, null=True)),
                ('codigoVerificacion', models.IntegerField(blank=True, null=True)),
