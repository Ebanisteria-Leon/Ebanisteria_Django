# Generated by Django 3.2.9 on 2022-06-15 12:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estadoProducto', models.CharField(default='', max_length=30, verbose_name='Estado del Producto')),
                ('destacado', models.CharField(default='', max_length=30, verbose_name='Tipo del Producto')),
                ('tiempoProducto', models.CharField(default='', max_length=30, verbose_name='Tiempo del Producto')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fechaInicio', models.DateField(null=True, verbose_name='Fecha de Inicio')),
                ('fechaFinalizacion', models.DateField(null=True, verbose_name='Fecha de Finalizacion')),
                ('estadoPromocion', models.CharField(default='', max_length=30, verbose_name='Estado de la Promocion')),
                ('tiempoPromocion', models.CharField(default='', max_length=30, verbose_name='Tiempo de la Promocion')),
                ('idProducto', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='products.producto', verbose_name='Identificar del Producto')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idProducto', models.ForeignKey(blank=True, db_constraint=False, default='', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='products.producto', verbose_name='Identificar del Producto')),
            ],
            options={
