    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fechaModificacion', models.DateField(auto_now_add=True, verbose_name='Fecha de Modificacion')),
                ('fechaEliminacion', models.DateField(auto_now_add=True, verbose_name='Fecha de Eliminacion')),
                ('idImagenes', models.AutoField(primary_key=True, serialize=False, verbose_name='Identificador de Imagenes')),
                ('nombreProducto', models.CharField(blank=True, max_length=50, null=True, verbose_name='Nombre producto Imagenes')),
                ('imagenProducto', models.ImageField(blank=True, null=True, upload_to='products/', verbose_name='Imagen de los productos')),
            ],
            options={
                'verbose_name': 'Imagen',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estadoProducto', models.CharField(max_length=15, verbose_name='Estado del Producto')),
                ('idCategoria', models.ManyToManyField(to='products.Categoria', verbose_name='Indicador de Categoria')),
                ('idImagenes', models.ManyToManyField(to='products.ImagenesProductos', verbose_name='Indentificador de Imagen')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='HistoricalImagenesProductos',
            fields=[
                ('estadoCreacion', models.BooleanField(default=True, verbose_name='Estado de Creacion')),
                ('fechaCreacion', models.DateField(blank=True, editable=False, verbose_name='Fecha de Creacion')),
                ('fechaModificacion', models.DateField(blank=True, editable=False, verbose_name='Fecha de Modificacion')),
                ('fechaEliminacion', models.DateField(blank=True, editable=False, verbose_name='Fecha de Eliminacion')),
                ('idImagenes', models.IntegerField(blank=True, db_index=True, verbose_name='Identificador de Imagenes')),
                ('nombreProducto', models.CharField(blank=True, max_length=50, null=True, verbose_name='Nombre producto Imagenes')),
                ('imagenProducto', models.TextField(blank=True, max_length=100, null=True, verbose_name='Imagen de los productos')),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField(db_index=True)),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
            ...
            options={
                'verbose_name': 'historical Imagen',
                'verbose_name_plural': 'historical Imagenes',
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': ('history_date', 'history_id'),
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
