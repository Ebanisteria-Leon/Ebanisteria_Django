    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagen', models.ImageField(blank=True, max_length=255, null=True, upload_to='', verbose_name='Nombre producto Imagenes')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(blank=True, max_length=255, null=True)),
                ('calificacion', models.PositiveSmallIntegerField(default=0, verbose_name='Calificacion de productos')),
                ('imagen', models.TextField(blank=True, max_length=255, null=True, verbose_name='Nombre producto Imagenes')),
                ('fechaInicio', models.DateField(verbose_name='Fecha de Inicio')),
                ('fechaFinalizacion', models.DateField(verbose_name='Fecha de Finalizacion')),
                ('estadoProducto', models.CharField(max_length=15, verbose_name='Estado del Producto')),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
