    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estadoProducto', models.CharField(default='D', max_length=30, verbose_name='Estado del Producto')),
                ('estadoPromocion', models.BooleanField(default=False, verbose_name='Estado de la Promocion')),
                ('destacado', models.CharField(default='DE', max_length=30, verbose_name='Tipo del Producto')),
                ('tiempoProducto', models.CharField(default='NUE', max_length=30, verbose_name='Tiempo del Producto')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estadoPromocion', models.CharField(default='ACT', max_length=30, verbose_name='Estado de la Promocion')),
                ('tiempoPromocion', models.CharField(default='NUE', max_length=30, verbose_name='Tiempo de la Promocion')),
                ('idProducto', models.ManyToManyField(default='', to='products.Producto', verbose_name='Identificar del Producto')),
            ],
            options={
